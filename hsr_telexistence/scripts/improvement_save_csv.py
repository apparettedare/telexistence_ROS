...
def main():
    ...
    file_name =  "/home/sobits/catkin_ws/src/csv/improvement/result_" + str(t_now.year) + "_" + str(t_now.month) + "_" + str(t_now.hour) + "_" + str(t_now.minute) + "_" + str(t_now.second) + ".csv"
    r = rospy.Rate(100)
